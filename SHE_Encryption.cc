...
public:
    ...
    Integer Encryption(const Integer&, const pair<Integer, Integer> &, const Integer&);
    Integer Decryption(const pair<Integer, Integer>&, const Integer&);
};
...
Integer SHE::Encryption(const Integer& plain_txt, const pair<Integer, Integer>& sk, const Integer& N)
{
...
Integer SHE::Decryption(const pair<Integer, Integer>& sk, const Integer& cipher_txt)
{
